...
const Crosshred: () => React$Node = ({navigation}) => {
  return (
    <View style={styles.container}>
      <VideoPlayer
        video={{
          uri:
            apiConfig.baseUrlVideo +
            'Andrei-Deiu-Motivation-2020-Alan-Walker-Alone-YouTube.mp4',
        }}
        videoWidth={1600}
        videoHeight={1400}
      ...
      <View style={styles.SectionStyle}>
        ...
        <Text style={styles.headingTextSub}>
          Keep your elbow pinned to your side to keep this focused in your
          shoulder.
        </Text>
      </View>
